    ...
    <div id='About' className='h-screen snap-start relative overflow-hidden'>
      <img src="/images/Alone-pana.png"  className='w-full absolute  left-0 right-0 -bottom-1/2 object-cover h-full' alt="" />
        <div className='flex justify-center text-center items-center flex-col w-full h-full'>
            ...
            <Slide direction='up'>
            <p className='text-center p-4  shadow-2xl font-bold text-xl'>Expirienced Frontend Engineer with ability to Undertake Any project from scratch to production Build 
            </p>
            </Slide>

            <Slide delay={200} direction='up'>
            <p className='text-center shadow-2xl p-4 font-bold text-xl'>
              Have ability to grasp new technologies in very short span of time ,Have a top notch probnlem solving attitude to perform in complex situations, I Have developed varios application using React, Redux , Electron js , React native ,
